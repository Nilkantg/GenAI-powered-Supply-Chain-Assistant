...
class UserQueryInput(BaseModel):
    # GROQ_API_KEY: Optional[Annotated[str, Field(default=os.getenv("GROQ_API_KEY"), description="Groq API key for authentication")]]
    # HF_TOKEN: Optional[Annotated[str, Field(default=os.getenv("HF_TOKEN"), description="Hugging Face token for model access")]]
